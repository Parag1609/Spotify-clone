...
async function getSongs(folder) {
    currfolder = folder;
    let a = await fetch(`https://spotiifyy.freewebhostmost.com/songs/${folder}/`);
...
async function displayalbums() {
    let a = await fetch(`https://spotiifyy.freewebhostmost.com/songs/`);
    let response = await a.text();
    let div = document.createElement("div");
    div.innerHTML = response;
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/songs/") && !e.href.includes(".htaccess")) {
            ...
            let a = await fetch(`https://spotiifyy.freewebhostmost.com/songs/${folder}/info.json`);
            ...
            <div data-folder="${folder}" class="card">
                            ...
                            <img src="https://spotiifyy.freewebhostmost.com/songs/${folder}/cover.png" alt="">
...
async function main() {
    ...
    await getSongs(`https://spotiifyy.freewebhostmost.com/songs/1anuv`);
